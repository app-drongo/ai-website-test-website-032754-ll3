...
const DEFAULT_HERO = {
  ...
  description:
    'The ultimate testing platform for developers, designers, and product teams. Launch experiments, gather feedback, and iterate faster than ever.',
  features: [
